...
# v1.1.9 Detection Speed: Check hardware state every 1 second.
WATCHDOG_HEARTBEAT = 1000

# Cooling period after a physical change or recovery trigger to prevent double-starts.
WATCHDOG_SETTLE_DELAY = 8000
...
# --- reconnect_helper.py ---
# Ensures the network stack is "quiet" before the helper tries to rebuild the tunnel.
